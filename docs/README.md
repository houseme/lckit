...
|---------|-------------|-------|
| `lckit setup` | Interactive stack install | [setup](en/setup.md) |
| `lckit site` | static / php / proxy vhosts | [site](en/site.md) |
| `lckit app` | Backend systemd units | [app](en/app.md) |
| `lckit db` | MariaDB & PostgreSQL | [db](en/db.md) |
| `lckit php` | PHP-FPM | [php](en/php.md) |
| `lckit php ext` | PHP extensions | [php ext](en/php-ext.md) |
| `lckit mirror` | Package mirrors | [mirror](en/mirror.md) |
| `lckit doctor` | Health check | [doctor](en/doctor.md) |
